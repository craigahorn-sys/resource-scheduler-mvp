...
RESOURCE_CLASSES = [
    ...
    ('10" Layflat Hose', 'Hose', 'miles', 'quantity_only'), ('12" Layflat Hose', 'Hose', 'miles', 'quantity_only'),
    ('14" Layflat Hose', 'Hose', 'miles', 'quantity_only'), ('16" Layflat Hose', 'Hose', 'miles', 'quantity_only'),
    ('6" Clamps', 'Clamps', 'count', 'quantity_only'), ('8" Clamps', 'Clamps', 'count', 'quantity_only'),
    ...
    ('8x6 Pumps', 'Pumps', 'units', 'quantity_then_specific'), ('Super 8x6 Pumps', 'Pumps', 'units', 'quantity_then_specific'),
    ('12x8 Pumps', 'Pumps', 'units', 'quantity_then_specific'), ('12x10 Pumps', 'Pumps', 'units', 'quantity_then_specific'),
    ('6" Filter Pods', 'Filtration', 'units', 'quantity_then_specific'), ('10" Filter Pods', 'Filtration', 'units', 'quantity_then_specific'),
